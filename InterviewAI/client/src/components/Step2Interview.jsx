...
// flow -: load voice -> intro speak -> question speak -> mic on -> timer running- > submit -> feddback speak -> next questions -> repeat -> finish
function Step2Interview({ interviewData, onFinish }) {
  ...
  useEffect(() => {
    const loadVoices = () => {
      ...
      // Try to find current female voice
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200">
          ...
          {subtitle && (
            <div className='w-full max-w-md bg-gray-50 border border-x-gray-200 rounded-xl p-4 shadow-sm'>
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            ...
            <div className='grid grid-cols-2 gap-6 text-center'>
              ...
              <div>
                <span className='text-2xl font-bold text-semibold-600'>{currentIndex + 1}</span>
                <span className='text-xs text-gray-400'>Current Questions</span>
              </div>

              <div>
                <span className='text-2xl font-bold text-semibold-600'>5</span>
    ...
    focus:ring-emerald-500 transition text-gray-800"
         ...
         {!feedback ? (<div className='flex items-center gap-4 mt-6'>
            ...
            <motion.div className="mt-6 bg-emerald-50 border-emerald-200 p-5 rounded-2xl sahdow-sm">

              <p className='text-emerald-700 font-medium mb-4'>{feedback}</p>

              <button
              onClick={handleNext}
              className='w-full bg-gradient-to-r from bg-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1'>
