...
function Step1SetUp({ onStart }) {
  ...
  const handleStart = async()=>{
    ...
    try{
      ...
      const message = err.response?.data?.message || "Unable to start the interview. Please try again.";
      console.error("Failed to start interview:", err.response?.data || err);
      setStartError(message);
      setLoading(false);
    }
  }
  return (
    // step 1  me hum jo hme data milega role , expreince , skill , project from interview contoller me se use hme yha pr fetch krke show krna hai step1 me as simple as that
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.6 }}
      className='min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 p-12 flex items-center justify-center'
    >
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        >
          ...
          <p className='text-gray-600 mb-10'>
            ...
            improved communication , techinical skills , and confidence.
          </p>
          ...
          <div className='space-y-6'>
            <div className='relative'>
              ...
              <input type="text" placeholder='Enter role'
                className='w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl foucs:ring-2 focus:ring-green-500 outline-none transition'
